...
// @version      1.5.2
// @description  Unified script: Tracks TIV + recon stats (Battlefield, Attack, Armory, Recon, Base). Syncs player + TIV data to API. Provides roster dashboards with multi-tab views: Roster, Top TIV, All Stats. Adds XP → Attack Turn trading calculator (Sidebar, Popup, Attack Log, Recon).
// @author       Trevor & ChatGPT
// @match        https://www.kingsofchaos.com/*
// @icon         https://www.kingsofchaos.com/favicon.ico
// @grant        none
// @updateURL    https://raw.githubusercontent.com/<your-repo>/KoC-DataCentre.user.js
// @downloadURL  https://raw.githubusercontent.com/<your-repo>/KoC-DataCentre.user.js
// ==/UserScript==
...
(function() {
 ...
 function updatePlayerInfo(id, patch) {
  ...
  const prev = map[id] || {};
  const updated = { ...prev, ...patch, lastSeen: new Date().toISOString() };
